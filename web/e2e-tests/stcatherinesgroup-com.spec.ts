...
const BASE_URL = process.env.STCATHERINESGROUP_BASE_URL ?? "http://localhost:35421";
...
test.describe("Services Pages", () => {
    const servicesPages = [
        ...
        {url: "/services/1-1-companionship-carer", name: "1-1 Companionship Carer"},
...
test.describe("All Pages Load", () => {
    const pages = [
        ...
        {url: "/services/1-1-companionship-carer", name: "services-companionship"},
        {url: "/services/1-1-dementia-carer", name: "services-dementia"},
        {url: "/services/1-1-safety-carer", name: "services-safety"},
        {url: "/services/personal-assistants", name: "services-personal-assistants"},
    ];
