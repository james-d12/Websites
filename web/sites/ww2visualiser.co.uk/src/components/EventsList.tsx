        ...
        <div className="flex flex-col gap-3 mb-6">
          ...
          <div className="flex gap-3 flex-wrap items-center">
            ...
            <select
              value={theater}
              onChange={(e) => {
                setTheater(e.target.value as Theater | "");
                resetPage();
              }}
              className="bg-surface border border-rim rounded-md px-3 py-2 text-sm text-dim focus:outline-none focus:border-accent transition-colors"
            >
            ...
            return (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 mb-3">
                  <h2 className="text-ink font-semibold text-base leading-snug">
                    {event.title}
                  </h2>
                ...
                <div className="flex flex-wrap gap-1.5 mb-3">
                  <span
                    className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium border ${CATEGORY_COLORS[event.category]}`}
                  >
                  ...
                  {event.sides && (
                    <>
                      ...
                      {event.sides.allied.length > 0 &&
                        event.sides.axis.length > 0 && (
